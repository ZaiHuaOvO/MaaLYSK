...
1. 下载并安装VSCode
   ...
   <img src="/doc_image/image-20251222231854640.png" alt="image-20251222231854640" style="zoom:67%;" />
...
2. 下载并安装git（官网：<https://git-scm.com/> ）
   ...
   <img src="/doc_image/image-20251222231248389.png" alt="image-20251222231248389" width="45%" />

 <img src="/doc_image/image-20251222231327262.png" alt="image-20251222231327262" width="45%" />
...
3. 按照提示fork好之后，接下来就会来到你的个人仓库，可以看到标题是 **“你的用户名/MaaLYSK**”，下面一行小字 **forked fromWitty36/MaaLYSK**（复制自 MaaYuan 主仓库）
    ...
    *图片仅为示例，应该`fork`MaaLYSK主仓库而不是MaaFramework！
     ...
     <img src="/doc_image/image-20251222230153165.png" alt="image-20251222230153165" style="zoom:67%;" />
...
4. 克隆你自己的仓库到本地，并拉取子模块
    ...
    *想要在指定文件夹下载？在你心仪的文件夹右键——`在终端中打开`/`Open git bash here`输入git命令。
    ...
    <img src="/doc_image/image-20251222232614196.png" alt="image-20251222232614196" width="20%" />
    ...
    >
    > <img src="/doc_image/image-20251222233450703.png" alt="image-20251222233450703" width="20%" />
...
<img src="/doc_image/8f4e3842270fbef01c4c77fab93e9bf.jpg" alt="8f4e3842270fbef01c4c77fab93e9bf" width="60%" />
